...
void main_page_html(WiFiClient *client)
{
    ...
    client->print("<h1>Makerfabs</h1><br><h2>SenseLoRa Industrial-grade Air Monitor</h2><br>");
    ...
    client->print("<table border=\"2\"><tr><td>Temp(C)</td><td>RH(%)</td><td>eCO2</td><td>lux</td>");
    client->print("<td>Battery</td></tr><tr><td>");
